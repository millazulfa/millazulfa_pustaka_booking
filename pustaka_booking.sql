...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Okt 2021 pada 13.43
...
('root', '[{\"db\":\"pustaka\",\"table\":\"tabel_buku\"},{\"db\":\"pustaka\",\"table\":\"kategori\"},{\"db\":\"pustaka\",\"table\":\"role\"},{\"db\":\"pustaka\",\"table\":\"user\"},{\"db\":\"db_kampus\",\"table\":\"mahasiswa\"}]');
...
('root', '2021-10-25 11:42:40', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
...
INSERT INTO `role` (`id_katalog`, `role`) VALUES
(1, 'administrator'),
(2, 'member');
...
(1, 'statistika dengan progam komputer', 1, 'ahmad kholikul amin', 'deep publish', 2014, '9786022809432', 6, 1, 1, '1.jpg'),
...
(16, 'Kolaborasi Codeigniter dan Ajax dalam Perancangan', 1, 'Anton Subagia', 'Elex Media Kompurindo', 2015, '43345356577', 5, 0, 0, '7.jpg'),
